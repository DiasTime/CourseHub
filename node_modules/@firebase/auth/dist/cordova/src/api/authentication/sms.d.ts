...
export interface VerifyPhoneNumberForExistingRequest extends SignInWithPhoneNumberRequest {}
...
export declare function verifyPhoneNumberForExisting(auth: Auth, request: VerifyPhoneNumberForExistingRequest): Promise<SignInWithPhoneNumberResponse>;
