...
export function getFakeHeartbeatServiceProvider(fakeLogString?: string): Provider<'heartbeat'> {
  // Implementation here
}

export function getFakeGreCAPTCHA(isTopLevel?: boolean): GreCAPTCHATopLevel | GreCAPTCHA {
  // Implementation here
}
 ...
 * care about it.
 */
export function findGreCaptchasScriptsOnPage(): HTMLScriptElement[] {
  // Implementation here
}

export function removeGreCaptchasScriptsOnPage(): void {
  // Implementation here
}
