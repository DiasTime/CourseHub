...
export const FETCH_TIMEOUT_MILLIS = 10000; // explicitly set type as number

export const DYNAMIC_CONFIG_URL = `https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig`;

/** Google Tag URL */
export const GTAG_URL = "https://www.googletagmanager.com/gtag/js";

/** Enumeration of Gtag commands */
